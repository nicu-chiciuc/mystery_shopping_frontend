(function() {
  ...
  /** @ngInject */
  function config ( $httpProvider, $logProvider, $mdDateLocaleProvider, toastrConfig, RestangularProvider, localStorageServiceProvider, $translateProvider, urls, $mdThemingProvider, moment ) {
    // Enable log
